...
public class TestOfTask1
{
    ...
    public void CheckingEquivalence()
    {
        ...
        var result1 = Task1.IsMin(testMas1);
        var result2 = Task1.IsMin(testMas2);
        var result3 = Task1.IsMin(testMas3);
        var result4 = Task1.IsMin(testMas4);
    ...
    {
        int[] testMas = null;
        Assert.Throws<ArgumentNullException>(() => Task1.IsMin(testMas));
    }
    [Test]
    public void CheckingErrorOfEmptyString()
    {
        int[] emptyMas = new int[0];
        Assert.Throws<ArgumentException>(() => Task1.IsMin(emptyMas));
    }
}
